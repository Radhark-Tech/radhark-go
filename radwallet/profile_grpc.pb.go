...
func (c *profileClient) GetProfile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProfileResponse, error) {
	out := new(ProfileResponse)
...
func (UnimplementedProfileServer) GetProfile(context.Context, *emptypb.Empty) (*ProfileResponse, error) {
